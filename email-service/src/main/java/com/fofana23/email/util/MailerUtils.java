package com.fofana23.email.util;
...
public class MailerUtils {
    private static final String email = "alfof1738@gmail.com";
    private static final String password = "247@lfof";
    private static final String templatePath = String.format("%s/templates/email.html", System.getProperty("user.dir"));
    String path = System.getProperty("user.dir") + "/templates/register.html";
